...
<div class="row">
    <div class="col-xs-11">
        <div class="widget-header">
            <h1 class="widget-title">Listado de Proveedores</h1>
        </div>
        ...
        <div>
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable" >
                <thead>
                    <tr>
                        ...
                        <th>#</th>
                        <th>Rif</th>
                        <th class="hidden-480">Razón Social</th>
					...
					<!--//Campo activo-->
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons"margin= "auto">
                                <a href = <?php echo base_url().'index.php/transporte/Transporte/modificar_proveedor/'.$row->id; ?>><i class="ace-icon fa fa-pencil bigger-130"></i></a>
         ...
         <?php }}else{ print "No hay datos que mostrar<br><br>";  } ?>
            ...
            <a style="top:39px; right:91px ;"class="btn btn-group dt-button buttons-csv buttons-html5 btn btn-white btn-primary btn-bold" 
               tabindex="0" aria-controls="dynamic-table" 
               title="Agregar Proveedor" data-rel="tooltip"  href = <?php echo base_url() . 'index.php/transporte/Transporte/crear_proveedor'; ?>>
                <span>
                    <i class=" bigger-110 fa fa-users green "></i> 
                </span>
            </a>
            <!-- BOTON DE AGREGAR -->   
