<?php
	foreach ($vehiculos as $row){	
		$placa = array('value' => $row->placa, 'name' => 'placa','class' =>'form-control', 'placeholder' => 'Placa','required'=>'true');
		$placa_chuto = array('value' => $row->placa_chuto, 'name' => 'placa_chuto','class' =>'form-control', 'placeholder' => 'Placa Chuto','required'=>'true');
		$placa_tanque = array('value' => $row->placa_tanque, 'name' => 'placa_tanque','class' =>'form-control', 'placeholder' => 'Placa Tanque','required'=>'true');
	
	
		$modelo = array('value' => $row->modelo, 'name' => 'modelo','class' =>'form-control', 'placeholder' => 'Modelo','required'=>'true');
		$marca = array('value' => $row->marca, 'name' => 'marca','class' =>'form-control', 'placeholder' => 'Marca','required'=>'true');
		$anio = array('value' => $row->anio, 'name' => 'anio','class' =>'form-control', 'placeholder' => 'Año','required'=>'true');
		$observacion = array('value' => $row->observacion, 'name' => 'observacion','class' =>'form-control', 'placeholder' => 'Observacion de vehiculo','required'=>'true');
	}
?>
<div class="col-sm-12">
    <div class="widget-header">
        <h1 class="widget-title">Modificar Vehiculos</h1>
    </div>
</div>
