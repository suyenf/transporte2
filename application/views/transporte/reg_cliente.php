<?php
	...
	$razon_social = array('name' => 'razon_social','class' =>'form-control', 'placeholder' => 'Razon Social del Cliente');
	...
	<div class="col-xs-12">
		<form class="form-horizontal" action="<?php base_url('transporte/transporte/crear_cliente'); ?>" method="post" role="form">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><big><strong> RIF de Cliente</strong></big> </label>
				<div class="col-sm-9">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"><big><strong> Razon Social de Cliente</strong></big> </label>
				<div class="col-sm-9">
