...
<div class="row">
    <div class="col-xs-11">
        <div class="widget-header">
            <h1 class="widget-title">Listado por Clientes</h1>
        </div>
...
//                                            $T == ("$act1,$act2");
         ...
         <?php }}else{ print "No hay datos que mostrar<br><br>";  } ?>
            ...
            tabindex="0" aria-controls="dynamic-table" 
                title="Agregar Cliente" data-rel="tooltip"  href = <?php echo base_url() . 'index.php/transporte/Transporte/crear_cliente'; ?>>
                <span>
                    <i class=" fa fa-user bigger-110 orange2"></i> 
                    <span class="hidden">Agregar Cliente</span></span>
            </a>
            <!-- BOTON DE AGREGAR -->
        </div>
</div>
