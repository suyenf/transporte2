<?php
	foreach ($choferes as $row){	
		$cedula = array('value' => $row->cedula, 'name' => 'cedula','class' =>'form-control', 'placeholder' => 'Cedula Chofer','required'=>'true');
		$nombre = array('value' => $row->nombre, 'name' => 'nombre','class' =>'form-control', 'placeholder' => 'Nombre Chofer','required'=>'true');
		$observacion = array('value' => $row->observacion, 'name' => 'observacion','class' =>'form-control', 'placeholder' => 'Observacion de Chofer');
	}
?>
<div class="col-sm-12">
    <div class="widget-header">
        <h1 class="widget-title">Modificar Choferes</h1>
    </div>
</div>
