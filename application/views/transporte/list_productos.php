...
<div >
    <div class="col-xs-12">
        <div class="widget-header">
            <h1 class="widget-title">Productos</h1><br>
        </div>

 <a href="<?= base_url('index.php/transporte/Transporte/crear_producto')?>">
	<br><button class="btn btn-lg btn-success">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				?>
                        ...
                        <!--</td>-->
                         ...
                         <td> <?php echo ++$i; ?></td>
                <a href="<?= base_url("/index.php/transporte/transporte/modificar_producto/{$row->id}{$row->nombre}") ?>"></a>
