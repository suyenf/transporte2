...
!function(a) {
    ...
    a.extend(i.prototype, {
        action: function(a, b) {
            ...
            this.s.dt;
            return b === d ? c.action : (c.action = b,
            this)
        },
        active: function(a, b) {
            var c = this._indexToButton(a)
              , e = this.c.dom.button.active;
            return b === d ? c.node.hasClass(e) : (c.node.toggleClass(e, b === d ? !0 : b),
            this)
        },
        add: function(a, b) {
        ...
        removeCommit: function() {
            ...
            for (a = d.length - 1; a >= 0; a--)
                null === d[a] && (d.splice(a, 1),
                e.splice(a, 1),
                this.c.buttons.splice(a, 1));
            for (a = 0,
            b = e.length; b > a; a++)
                for (c = e[a].length - 1; c >= 0; c--)
                    null === e[a][c] && (e[a].splice(c, 1),
                    this.c.buttons[a].buttons.splice(c, 1));
            return this
        },
        ...
        text: function(a, b) {
            ...
            return b === d ? h(c.conf.text) : (c.conf.text = b,
            ...
            for (var h = 0, i = b.length; i > h; h++) {
                ...
                if (j)
                    if (a.isArray(j))
                        ...
                        if (k) {
                            var l = k.node;
                            if (c.append(k.inserter),
                            e === d ? (this.s.buttons.push({
                                node: l,
                                conf: j,
                                inserter: k.inserter
                            }),
        ...
        collection: {
            ...
            action: function(d, e, f, g) {
                var h = f
                  ...
                  , l = !1;
                a("div.dt-button-background").length && (l = a("div.dt-button-collection").offset(),
    ...
    e.Api.register("buttons.info()", function(b, c, e) {
        ...
        clearTimeout(j),
        j = null,
        this) : (j && clearTimeout(j),
        a("#datatables_buttons_info").length && a("#datatables_buttons_info").remove(),
        b = b ? "<h2>" + b + "</h2>" : "",
        a('<div id="datatables_buttons_info" class="dt-button-info"/>').html(b).append(a("<div/>")["string" == typeof c ? "html" : "append"](c)).css("display", "none").appendTo("body").fadeIn(),
        e !== d && 0 !== e && (j = setTimeout(function() {
            f.buttons.info(!1)
        }, e)),
        this)
    }),
    ...
    var k = a("<textarea/>")[0]
      , l = function(b, c) {
        for (var d = a.extend(!0, {}, {
            ...
            return "string" != typeof a ? a : (d.stripHtml && (a = a.replace(/<.*?>/g, "")),
            d.trim && (a = a.replace(/^\s+|\s+$/g, "")),
            d.stripNewlines && (a = a.replace(/\n/g, " ")),
            d.decodeEntities && (k.innerHTML = a,
            a = k.value),
            a)
